...
const Header = () => {
    ...
    return (
        ...
        <>
            ...
            <header>
                <nav id="nav" className="  fixed inset-x-0 top-0 flex flex-row justify-between z-10 text-white bg-[#2c1f83] bg-opacity-90 shadow-blue-500/50 shadow-2xl ">
                    ...
                    <div id="nav-open" className="p-4 md:hidden flex items-center">
                        <button onClick={toggleMenu} className="relative group">
                            <div className="relative flex overflow-hidden items-center justify-center rounded-full w-[50px] h-[50px] transform transition-all bg-transparent ring-0 ring-gray-300 hover:ring-8 group-focus:ring-4 ring-opacity-30 duration-200 ">
            ...
            <div ref={menuRef} id="nav-opened" className={`fixed left-0 right-0 top-[-30] bottom-0  ${isOpen ? "block" : "hidden"}  w-[50%]  mt-16 rounded-br rounded-bl shadow z-10 `}>
            <>
  <link
    rel="stylesheet"
      ...
      <ul className="flex flex-col py-4">
        ...
        <li>
          ...
          >
            ...
            <div id="up" className={`   flex  justify-center items-center h-screen`}>
                {/* hero bg */}
                <div className="justify-center items-center ">
                    <div className={`${styles.threeD}`}>
                        <h1 className="mb-10">Israel Pinto</h1>
                    </div>
                    ...
                    <div className="flex gap-20 mt-24 justify-center items-center">
                        <div id="twitter" className={`${styles.socialBtn} ${styles.flexCenter} justify-center items-center`}>
                            <svg fill="#211c1c" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
